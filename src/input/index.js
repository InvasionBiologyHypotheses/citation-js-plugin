 ...
 *
 * @module @citation-js/plugin-enkore
 */
...
const parsers = {
   ...
   * @access protected
   * @namespace id
   * @memberof module:@citation-js/plugin-enkore.parsers
   */
  id,
...
const formats = {
   ...
   * @memberof module:@citation-js/plugin-enkore.formats
  ...
  /**
   * List of {@link module:@citation-js/plugin-enkore.formats."@wikidata/id"|Wikidata IDs}.
   *
   * @type module:@citation-js/core.plugins.input~parsers
   * @memberof module:@citation-js/plugin-enkore.formats
   * @property {module:@citation-js/core.plugins.input~dataParser} parse
  ...
  /**
   * Array of {@link module:@citation-js/plugin-enkore.formats."@wikidata/api"|Wikidata API URLs}.
   *
   * @type module:@citation-js/core.plugins.input~parsers
   * @memberof module:@citation-js/plugin-enkore.formats
   * @property {module:@citation-js/core.plugins.input~dataParser} parse
  ...
  /**
   * URL to {@link module:@citation-js/plugin-enkore.formats."@wikidata/id"|Wikidata ID}.
   *
   * @type module:@citation-js/core.plugins.input~parsers
   * @memberof module:@citation-js/plugin-enkore.formats
   * @property {module:@citation-js/core.plugins.input~dataParser} parse
   ...
   * {@link module:@citation-js/plugin-enkore.formats."@wikidata/id"|Wikidata IDs}.
   *
   * @type module:@citation-js/core.plugins.input~parsers
   * @memberof module:@citation-js/plugin-enkore.formats
   * @property {module:@citation-js/core.plugins.input~dataParser} parse
  ...
  /**
   * Array of {@link module:@citation-js/plugin-enkore.formats."@wikidata/object"|Wikidata API responses}.
   *
   * @type module:@citation-js/core.plugins.input~parsers
   * @memberof module:@citation-js/plugin-enkore.formats
   * @property {module:@citation-js/core.plugins.input~dataParser} parse
